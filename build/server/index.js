...
const options = {
  ...
  templates: {
    app: ({ head, body, assets, nonce, env }) => '<!DOCTYPE html>\n<html lang="%lang%">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets + '/favicon.ico" />\n		<link rel="apple-touch-icon" href="' + assets + `/morlappo-logo.png" />
		...
		<meta name="keywords" content="WMS, magazzino, logistics, AI, gestionale, multicommittente, Morlappo" />
		<meta property="og:title" content="Gestionale Magazzino WMS - Morlappo" />
		<meta property="og:description" content="Sistema avanzato di gestione magazzino multicommittente con intelligenza artificiale" />
		<meta property="og:type" content="website" />
		<meta property="og:image" content="` + assets + '/morlappo-logo.png" />\n		<title>WMS Gestionale Magazzino - Morlappo Srl</title>\n		' + head + '\n	</head>\n	<body data-sveltekit-preload-data="hover">\n		<div style="display: contents">' + body + "</div>\n	</body>\n</html>",
...
async function get_hooks() {
  ...
  let init;
  ({ handle, handleFetch, handleError, handleValidationError, init } = await import('./chunks/hooks.server-Dmov-f84.js'));
  let reroute;
  let transport;
  return {
    handle,
