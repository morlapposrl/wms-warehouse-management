...
type LayoutRouteId = RouteId | "/" | "/auth" | "/auth/admin/committenti" | "/auth/admin/committenti/[id]/modifica" | "/auth/audit" | "/auth/categorie" | "/auth/causali" | "/auth/dashboard" | "/auth/dashboard-compact" | "/auth/fornitori" | "/auth/giacenze" | "/auth/listino-bottiglie" | "/auth/magazzini" | "/auth/magazzino" | "/auth/movimenti" | "/auth/movimenti/nuovo" | "/auth/ordini" | "/auth/ordini/[id]" | "/auth/ordini/nuovo" | "/auth/ottimizzazione" | "/auth/prodotti" | "/auth/sistema" | "/auth/tipi-udc" | "/auth/transfer" | "/auth/udc" | "/auth/udc/[id]" | "/auth/unita-misura" | "/auth/utenti" | "/auth/wave-planning" | "/auth/wave-planning/[id]" | "/login" | "/logs" | "/reset-password" | "/test-css" | null
