...
declare module "$app/types" {
	export interface AppTypes {
		...
		LayoutParams(): {
			...
			"/api/listino-bottiglie": Record<string, never>;
			...
			"/auth/listino-bottiglie": Record<string, never>;
